function ExternalBallistics() {
  ...
  this.DRAG_FUNCTIONS = {
    G1: {
      ...
      values: [
        { A: 1.477404177730177e-4, M: 1.9565 },
        { A: 1.920339268755614e-4, M: 1.925 },
        { A: 2.894751026819746e-4, M: 1.875 },
        { A: 4.349905111115636e-4, M: 1.825 },
        { A: 6.520421871892662e-4, M: 1.775 },
        { A: 9.748073694078696e-4, M: 1.725 },
        { A: 1.453721560187286e-3, M: 1.675 },
        { A: 2.162887202930376e-3, M: 1.625 },
        { A: 3.209559783129881e-3, M: 1.575 },
        { A: 3.904368218691249e-3, M: 1.55 },
        { A: 3.222942271262336e-3, M: 1.575 },
        { A: 2.203329542297809e-3, M: 1.625 },
        { A: 1.511001028891904e-3, M: 1.675 },
        { A: 8.609957592468259e-4, M: 1.75 },
        { A: 4.086146797305117e-4, M: 1.85 },
        { A: 1.954473210037398e-4, M: 1.95 },
        { A: 5.431896266462351e-5, M: 2.125 },
        { A: 8.847742581674416e-6, M: 2.375 },
        { A: 1.456922328720298e-6, M: 2.625 },
        { A: 2.419485191895565e-7, M: 2.875 },
        { A: 1.657956321067612e-8, M: 3.25 },
        ...
        { A: 1.045513263966272e-8, M: 3.25 },
        { A: 1.291159200846216e-7, M: 2.875 },
        { A: 6.824429329105383e-7, M: 2.625 },
        { A: 3.569169672385163e-6, M: 2.375 },
        { A: 1.839015095899579e-5, M: 2.125 },
        { A: 5.71117468873424e-5, M: 1.95 },
        { A: 9.226557091973427e-5, M: 1.875 },
        { A: 9.337991957131389e-5, M: 1.875 },
        { A: 7.225247327590413e-5, M: 1.925 },
        { A: 5.792684957074546e-5, M: 1.975 },
        { A: 5.206214107320588e-5, M: 2.0 },
      ],
    },
    G2: {
      ...
      values: [
        ...
        { A: 1.00419763721974e-3, M: 1.65392237010294 },
        { A: 7.15571228255369e-23, M: 7.91913562392361 },
        { A: 1.39589807205091e-10, M: 3.81439537623717 },
        { A: 2.34364342818625e-4, M: 1.71869536324748 },
        { A: 1.77962438921838e-4, M: 1.76877550388679 },
        { A: 5.18033561289704e-5, M: 1.98160270524632 },
      ],
    },
    G5: {
      thresholds: [1730, 1228, 1116, 1004, 837, 335, 0],
      values: [
        { A: 7.24854775171929e-3, M: 1.41538574492812 },
        { A: 3.50563361516117e-5, M: 2.13077307854948 },
        { A: 1.84029481181151e-13, M: 4.81927320350395 },
        { A: 1.34713064017409e-22, M: 7.8100555281422 },
        { A: 1.03965974081168e-7, M: 2.84204791809926 },
        { A: 1.09301593869823e-4, M: 1.81096361579504 },
        { A: 3.51963178524273e-5, M: 2.00477856801111 },
      ],
    },
    G6: {
      ...
      values: [
        ...
        { A: 7.167261849653769e-2, M: 1.10704436538885 },
        { A: 1.66676386084348e-3, M: 1.60085100195952 },
        { A: 1.01482730119215e-7, M: 2.9569674731838 },
        { A: 4.31542773103552e-18, M: 6.34106317069757 },
        { A: 2.04835650496866e-5, M: 2.11688446325998 },
        { A: 7.50912466084823e-5, M: 1.92031057847052 },
      ],
    },
    G7: {
      thresholds: [4200, 3000, 1470, 1260, 1110, 960, 670, 540, 0],
      values: [
        { A: 1.29081656775919e-9, M: 3.24121295355962 },
        { A: 0.0171422231434847, M: 1.27907168025204 },
        { A: 2.33355948302505e-3, M: 1.52693913274526 },
        { A: 7.97592111627665e-4, M: 1.67688974440324 },
        { A: 5.71086414289273e-12, M: 4.3212826264889 },
        { A: 3.02865108244904e-17, M: 5.99074203776707 },
        { A: 7.52285155782535e-6, M: 2.1738019851075 },
        { A: 1.31766281225189e-5, M: 2.08774690257991 },
        { A: 1.34504843776525e-5, M: 2.08702306738884 },
      ],
    },
    G8: {
...
ExternalBallistics.prototype.solveAll = function () {
  ...
  var gravityVectorX =
    this.gravity * Math.sin(this.degToRad(this.shootingAngle + zeroAngle));
  var gravityVectorY =
    this.gravity * Math.cos(this.degToRad(this.shootingAngle + zeroAngle));
  ...
  for (var time = 0; ; time = time + deltaTime) {
    ...
    if (currentRange / 3 >= this.maximumValidRange) {
      ...
      this.solution[
        10 * this.maximumValidRange + 4
      ] = this.getWindageDeflection(
        crossWind,
        this.muzzleVelocity,
        currentRange,
        time + deltaTime
      ...
      this.solution[10 * this.maximumValidRange + 5] = this.radToMinuteOfAngle(
        Math.atan(
          this.solution[10 * this.maximumValidRange + 4] /
            12 /
...
ExternalBallistics.prototype.getWindageDeflection = function (
  windSpeed,
  muzzleVelocity,
  range,
  time
) {
  windVelocity = windSpeed * 17.6; // Convert to inches per second.
...
ExternalBallistics.prototype.getZeroAngle = function () {
  ...
  for (angle = 0; ; angle = angle + deltaAngle) {
    ...
    for (
      time = 0, currentRange = 0, currentHeight = 0 - this.sightHeight / 12;
      currentRange <= this.zeroRange * 3;
      time = time + deltaTime
    ) {
      velocityY1 = velocityY;
      velocityX1 = velocityX;
